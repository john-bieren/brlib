...
"""Tests attributes and methods of the Team class."""
...
def test_info(teams_list: list[br.Team]) -> None:
...
def test_batting(teams_list: list[br.Team]) -> None:
...
def test_fielding(teams_list: list[br.Team]) -> None:
