...
def test_opponents():
    ...
    assert find_games("LAD", seasons="2020", opponents=["oak", "TEX"]) == [
        ("TEX", "20200828", "0"), ("TEX", "20200829", "0"), ("TEX", "20200830", "0"),
        ("LAD", "20200922", "0"), ("LAD", "20200923", "0"), ("LAD", "20200924", "0")
    ]
...
def test_dates():
    ...
    assert find_games(teams="SEA", seasons="2018", dates=["501-502", "508"]) == [
        ("SEA", "20180501", "0"), ("SEA", "20180502", "0"), ("TOR", "20180508", "0")
    ]
...
def test_game_type():
    ...
    assert find_games("SEA", "2022", game_type="POST") == [
        ("TOR", "20221007", "0"), ("TOR", "20221008", "0"), ("HOU", "20221011", "0"),
        ("HOU", "20221013", "0"), ("SEA", "20221015", "0")
    ]
